...
public class SqlConnection implements Closeable {
    ...
    private static final CommonVars<String> SQL_DRIVER_CLASS =
            CommonVars.apply("wds.linkis.server.mdm.service.sql.driver", "com.pivotal.jdbc.GreenplumDriver");

    private static final CommonVars<String> SQL_CONNECT_URL =
            CommonVars.apply("wds.linkis.server.mdm.service.sql.url", "jdbc:pivotal:greenplum://%s:%s;DatabaseName=%s");
